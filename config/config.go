...
// Config store main configuration information
type Config struct {
	AppName string
	AppEnv  string
	Port    string
...
// InitConfig reads configuration from .env file (if exists) or OS environment.
...
// loadDotEnv reads .env file into map[string]string.
